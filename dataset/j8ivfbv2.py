...
class j8ivfbv2(data.Dataset):
    def __init__(self, dir_path, depth, split, use_hdf5=True):
        ...
        hdf5_path = './datasets/j8ivfbv2.hdf5'
        # Sequence profiles (e.g. longdress10/) ship their own PLYs. Prefer those
        # over the shared HDF5, which mixes all sequences and would make every
        # sequence profile evaluate the same frames.
        ...
        if self.use_hdf5:
            if not os.path.exists(hdf5_path):
                ...
                _ensure_hdf5_available(hdf5_path, 'j8ivfbv2')
